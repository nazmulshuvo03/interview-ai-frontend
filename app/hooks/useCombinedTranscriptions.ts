...
export default function useCombinedTranscriptions() {
  ...
  console.log("agentTranscription", agentTranscriptions);
  console.log("userTranscription", userTranscriptions, micTrackRef);
  ...
  console.log("combinedTranscriptions", combinedTranscriptions);
